...
def index():
    ...
    if "username" in session:
        ...
        return render_template(
            "test_section/home.html", data=data, username=session["username"]
        )
    else:
...
def start_quiz_get():
    ...
    timer_value = request.args.get('test_duration')
 
    return render_template("test_section/instructions.html", test_id = test_id , test_duration = timer_value)
